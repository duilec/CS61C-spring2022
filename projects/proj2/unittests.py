...
class TestRelu(TestCase):
	# MY TEST BEGIN
    def test_relu_greater(self):
        # load the test for relu.s
        t = AssemblyTest(self, "relu.s")
        # create an array in the data section
        array0 = t.array([1, -100000000000, 1000000000])
        ...
        t.check_array(array0, [1, 0, 1000000000])
...
class TestArgmax(TestCase):
	# MY TEST BEGIN
    def test_argmax_last_greatest(self):
        t = AssemblyTest(self, "argmax.s")
        # create an array in the data section
        array0 = t.array([3, -42, 432, 7, -5, 6, 5, -114, 2222])
    ...
    def test_argmax_more_once_greatest(self):
        t = AssemblyTest(self, "argmax.s")
        # create an array in the data section
        array0 = t.array([3, -42, 432, 7, 432, 6, 5, -114, 432])
        # load address of the array into register a0
        t.input_array("a0", array0)
        # set a1 to the length of the array
        t.input_scalar("a1", len(array0))
