...
bool test_is_tail() {
  ...
  if (!assert_true("It is NOT 'w'", is_tail('w'))) {
    return false;
  }
  if (!assert_true("It is NOT 'a'", is_tail('a'))) {
    return false;
  }
  if (!assert_true("It is NOT 's'", is_tail('s'))) {
    return false;
  }
  if (!assert_true("It is NOT 'd'", is_tail('d'))) {
    return false;
  }
  return true;
}
...
bool test_is_snake() {
  ...
  if (!assert_true("It is NOT 'w'", is_snake('w'))) {
    return false;
  }
  if (!assert_true("It is NOT 'a'", is_snake('a'))) {
    return false;
  }
  if (!assert_true("It is NOT 's'", is_snake('s'))) {
    return false;
  }
  if (!assert_true("It is NOT 'd'", is_snake('d'))) {
    return false;
  }
  if (!assert_true("It is NOT '^'", is_snake('^'))) {
    return false;
  }
  if (!assert_true("It is NOT '<'", is_snake('<'))) {
    return false;
  }
  if (!assert_true("It is NOT 'v'", is_snake('v'))) {
    return false;
  }
  if (!assert_true("It is NOT '>'", is_snake('>'))) {
    return false;
...
bool test_body_to_tail() {
  ...
  if (!assert_equals_char("It is NOT convert '^' to 'w'", 'w',
                          body_to_tail('^'))) {
    return false;
  }
  if (!assert_equals_char("It is NOT convert '<' to 'a'", 'a',
                          body_to_tail('<'))) {
    return false;
  }
  if (!assert_equals_char("It is NOT convert 'v' to 's'", 's',
                          body_to_tail('v'))) {
    return false;
  }
  if (!assert_equals_char("It is NOT convert '>' to 'd'", 'd',
                          body_to_tail('>'))) {
    return false;
  }
  return true;
...
bool test_incr_x() {
  ...
  if (!assert_equals_int("It is NOT return '1' by '>'", 1, incr_x('>'))) {
    return false;
  }
  if (!assert_equals_int("It is NOT return '1' by 'd'", 1, incr_x('d'))) {
    return false;
  }
  if (!assert_equals_int("It is NOT return '-1' by '<'", -1, incr_x('<'))) {
    return false;
  }
  if (!assert_equals_int("It is NOT return '-1' by 'a'", -1, incr_x('a'))) {
    return false;
  }
  // I only test 's'
  if (!assert_equals_int("It is NOT return '0' by other charater", 0,
                         incr_x('s'))) {
    return false;
  }
  return true;
...
bool test_incr_y() {
  ...
  if (!assert_equals_int("It is NOT return '1' by 's'", 1, incr_y('s'))) {
    return false;
  }
  if (!assert_equals_int("It is NOT return '1' by 'v'", 1, incr_y('v'))) {
    return false;
  }
  if (!assert_equals_int("It is NOT return '-1' by 'w'", -1, incr_y('w'))) {
    return false;
  }
  if (!assert_equals_int("It is NOT return '-1' by '^'", -1, incr_y('^'))) {
    return false;
  }
  // I only test 'a'
  if (!assert_equals_int("It is NOT return '0' by other charater", 0,
...
bool test_load_board() {
  if (!test_load_board_1()) {
    printf("%s\n",
           "test_load_board_1 failed. Check tests/1-simple-in.snk for a "
           "diagram of the board.");
    return false;
  }
  ...
  if (!test_load_board_2()) {
    printf("%s\n",
           "test_load_board_2 failed. Check tests/6-small-in.snk for a diagram "
           "of the board.");
    return false;
  }
...
bool test_find_head() {
  if (!test_find_head_board_1()) {
    printf("%s\n",
           "test_find_head_board_1 failed. Check unit-test-out.snk for a "
           "diagram of the board.");
    return false;
  }
...
bool test_initialize_snakes() {
  if (!test_initialize_snakes_board_1()) {
    printf("%s\n",
           "test_initialize_snakes_board_1 failed. Check unit-test-out.snk for "
  ...
  if (!test_initialize_snakes_board_2()) {
    printf("%s\n",
           "test_initialize_snakes_board_2 failed. Check unit-test-out.snk for "
           "a diagram of the board.");
    return false;
  }
